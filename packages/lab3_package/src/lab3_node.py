...
class Lab3:
    ...
    def lanefilter(self, msg):    
        ...
        # Hough transform
        self.hough_white = cv2.HoughLinesP(self.output_image_white,rho = 1,theta = math.pi/180.0,threshold = 10,minLineLength = 1,maxLineGap = 1)
        self.hough_yellow = cv2.HoughLinesP(self.output_image_yellow,rho = 1,theta = math.pi/180.0,threshold = 10,minLineLength = 1,maxLineGap = 1)
