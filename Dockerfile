# parameters
ARG REPO_NAME="quochuy_huynh_eece5560_fall2021"
ARG DESCRIPTION="Repo for UML EECE 5560 for Fall 2021 semester"
ARG MAINTAINER="Huy Huynh (quochuy_huynh@student.uml.edu)"
